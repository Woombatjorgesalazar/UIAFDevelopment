    ...
    for index,i in enumerate(dfp['nombrecatalogo']):
        if index == 0:
            ...
            if i == 'dimdanesistema':
                ...
                #dicc['campos'] = ['']
                diccfinal[i] = pre.preproc_factefectivo(hc, dicc)
    ...
    for index,i in enumerate(dfp['nombrecatalogo']):
        if index == 0:
            ...
            if i == "dimdanesiste":
                ...
                diccfinal[i] = t1.cruze_moneda_sistema(hc, dfcruzar, dicc)
                
            elif i == 'dimtipoproductosiste':
                ########################Procesamiento paises###########################
                ...
                diccfinal[i] = t1.cruze_tipo_producto_sistema(hc, dfcruzar, dicc, actualsin)
                ...
                diccfinal[i] = t1.cruze_producto_sistema(hc, dfcruzar, dicc, actual, actualsin)
                ...
                diccfinal[i] = t1.cruze_persona_sistema(hc, dfcruzar, dicc, actual, actualsin, idcargue)
