...
def cruze_tipo_producto_sistema(hc, dfcruzar, dicccruzar, actualsin):

    idsistema = dicccruzar['idsistema']
    idcatalogo = dicccruzar['idcatalogo']
    database = 'dwh_uiaf'
    namedfprincipal = 'dimtipoproductosistema'
    #dfdestino = 'dimmonedasistema'
    ...
    df = df.withColumn('idtipoproducto', lit(2).cast(IntegerType())) \
            ...
            .withColumn('tipoproducto', lit('No homologado').cast(StringType())) \
...
def cruze_producto_sistema(hc, dfcruzar, dicccruzar, actual, actualsin):
    ...
    namedfprincipal = 'dimproductosistema'
    ...
    df = df.withColumn('idpersona', lit(0).cast(IntegerType())) \
            ...
            .withColumn('identidad', lit(0).cast(IntegerType())) \
            ...
            .withColumn('estado', lit(0).cast(IntegerType())) \
            .withColumn('idtipoproducto', lit(0).cast(IntegerType())) 
