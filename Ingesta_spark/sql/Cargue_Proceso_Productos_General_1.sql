...
VALUES(3, 1, 'Cargue Producto General 1 (PG110)', 1, 'Manual', 'Hguerrero', '/home/woombatcg/proyectos/proyectos/', 10, 'PG110');
...
insert into tcatalogo (idtipocatalogo,nombrecatalogo ,idsistema ,descripcioncatalogo ,responsable,separador )
values(1,'PG110',2,'Reporte Productos Generales Ofrecidos 1 (PG110)','SIN','F');
...
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Numero_Producto','bigint',20,2),
...
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Municipio_Apertura','int',5,5),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Estado_Producto','int',1,6),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Entradas','bigint',20,7),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Salidas','bigint',20,8),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),2,'Saldo','bigint',20,9),
...
insert into tcatalogo (idtipocatalogo,nombrecatalogo ,idsistema ,descripcioncatalogo ,responsable,separador )
values(2,'PG110_ENCABEZADO',1,'Encabezado de Reporte Productos Generales Ofrecidos 1 (PG110)','SIN','F');
...
insert into tcatalogo (idtipocatalogo,nombrecatalogo ,idsistema ,descripcioncatalogo ,responsable,separador )
values(2,'PG110_DETALLES',1,'Detalles de Reporte Productos Generales Ofrecidos 1 (PG110)','SIN','F');
...
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),4,'Municipio_Apertura','int',5,5),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),4,'Estado_Producto','int',1,6),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),4,'Entradas','bigint',20,7),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),4,'Salidas','bigint',20,8),
(currval(pg_get_serial_sequence('tcatalogo', 'idcatalogo')),4,'Saldo','bigint',20,9);

insert into tcatalogo (idtipocatalogo,nombrecatalogo ,idsistema ,descripcioncatalogo ,responsable,separador )
values(2,'PG110_PIE',1,'Pie de Reporte Productos Generales Ofrecidos 1 (PG110)','SIN','F');
